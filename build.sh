...
echo "file.reference.antlr3.runtime.jar=/usr/share/java/antlr3-runtime.jar" >> tmp.properties
echo 'linux.manifest.classpath=${file.reference.antlr3.runtime.jar} ${file.reference.antlr3.jar} ${file.reference.joptsimple.jar}' >> tmp.properties
